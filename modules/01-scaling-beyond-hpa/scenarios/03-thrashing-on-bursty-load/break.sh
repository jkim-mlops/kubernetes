#!/usr/bin/env bash
# Restores the system to exactly what scenario 02 shipped, and points bursty
# traffic at it. There is no fault injected here at all: the configuration is
# the previous scenario's correct answer, meeting a traffic shape it was not
# chosen for.
set -euo pipefail
...
log::ok "system is idle and waiting for the next wave"
